        ...
        <div className="p-4 md:p-6 max-w-7xl mx-auto animate-in fade-in duration-500 pb-24">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">View and manage registered customers on your platform.</p>
                </div>
            ...
            <div className="bg-card border border-border rounded-3xl shadow-theme-sm overflow-hidden min-h-[50vh]">
                {loading ? (
                    ...
                    <UserTable users={filteredCustomers} onDelete={handleDelete} basePath="/dashboard/super-admin/customers" />
                )}
            </div>
        </div>
    );
